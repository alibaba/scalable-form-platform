...
const localMessages = {
    ...
    actionCreatorsGetSelectFieldErrorTip: {
        ...
        defaultMessage: 'xform builder:获取初始生效字段配置接口失败：'
    },
    ...
    fieldConfigDuplicateCodeErrorTip: {
        ...
        defaultMessage: '输入的字段编码重复，请更改您输入的字段编码'
    },
    ...
    showConfigModalClearConfirmTitle: {
        ...
        defaultMessage: '您确认要清除当前字段的所有字段级联关系吗？'
    },
    ...
    updateFieldConfigModalClearConfirmTitle: {
        ...
        defaultMessage: '您确认要清除当前字段的所有数据级联配置吗？'
    },
    ...
    configSchemaLabelHelp: {
        ...
        defaultMessage: '普通文本字段允许设置标题为空，标题为空不展示标题'
    },
    ...
    configSchemaNamePlaceholder: {
        ...
        defaultMessage: '输入字段名称，不超过200字符'
    },
    ...
    configSchemaPlaceholderPlaceholder: {
        ...
        defaultMessage: '请输入字段的placeholder值'
    },
